...
Repositori  tugas praktikum mata kuliah **Pemrograman Web**, Jurusan Teknologi Informasi, **Politeknik Negeri Malang (POLINEMA)**.
...
| 05 | **Jobsheet 05** | DOM Manipulation & Form Validation (JavaScript) | [`/jobsheet5`](./jobsheet5) | ⏳ On Progress |
| 06 | **Jobsheet 06** | Asynchronous JavaScript, Fetch API & JSON | [`/jobsheet6`](./jobsheet6) | ⏳ On Progress |
...
│       ├── list.html
│       └── tambah.html
├── jobsheet2/              <-- Praktikum 2: CSS3 Styling Dasar
│   ├── index.html
│   ├── assets/css/
│   │   └── style.css
│   ├── buku/
